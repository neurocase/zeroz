...
//	public Vector2 velocity = new Vector2(0,0); 
	...
	public WallTurret(float x, float y, String type, int angle, World world, EntityManager entityMan, SceneManager scene){
		...
		TextureRegion turretBaseTexRegion = new TextureRegion(turretBaseTexture, 0, 0, 32,
				32);
		...
		turretBaseTexture.setFilter(TextureFilter.Linear, TextureFilter.Linear);
		TextureRegion turretbarrelTexRegion = new TextureRegion(turretbarreltexture, 0, 0, 16,
				64);
		...
		if (TurretType.equals("flamer")){
			...
			//turretbarrelsprite.setOrigin(turretbasesprite.getWidth()/2, turretbasesprite.getWidth()/2);
			//turretbarrelsprite.setOrigin(turretbasesprite.getWidth()/2, turretbasesprite.getHeight()/2);
